...
<form method="post" action="setup-config.php?step=2">
	...
	<table class="form-table" role="presentation">
		<tr>
			<th scope="row"><label for="dbname"><?php _e( 'tien' ); ?></label></th>
		...
		<tr>
			<th scope="row"><label for="uname"><?php _e( 'tienth' ); ?></label></th>
		...
		<tr>
			<th scope="row"><label for="pwd"><?php _e( '123456' ); ?></label></th>
